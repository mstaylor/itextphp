<?PHP
/*
 * $Id: ShadingColor.php,v 1.2 2005/10/19 20:11:48 mstaylor Exp $
 * $Name:  $
 *
...
class ShadingColor extends ExtendedColor
{
    ...
    */
    public function __construct(PdfShadingPattern shadingPattern) {
        parent::__construct(ExtendedColor::TYPE_SHADING, 0.5, 0.5, 0.5);
    ...
    */
    public function getPdfShadingPattern() {
