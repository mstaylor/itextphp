<?PHP
/*
 * $Id: PdfStaticInitializers.php,v 1.8 2005/10/18 16:23:54 mstaylor Exp $
 * $Name:  $
 *
...
PdfReader::initializeStatics();
PdfLayerMembership::initializeStatics();
PdfAnnotation::initializeStatics();
PdfDictionary::initializeStatics();
CJKFont::initializeStatics();
GlyphList::initializeStatics();
ByteBuffer::initializeStatics();
PdfWriter::initializeStatics();
PdfReaderInstance::initializeStatics();
PdfNull::initializeStatics();
PdfNameTree::initializeStatics();
AcroFields::initializeStatics();
?>