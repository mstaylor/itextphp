<?PHP
/*
 * $Id: PdfTextArray.php,v 1.2 2005/10/18 20:52:40 mstaylor Exp $
 * $Name:  $
 *
...
class PdfTextArray
{
    ...
    private construct1arg($str) {
        array_push($arrayList, $str);
    }

    private construct0args() {
    }
    ...
    */
    ...
    private function addPdfNumber(PdfNumber $number)
    {
        array_push($arrayList, $number);
    }

    private function addFloat($number)
    {
        array_push($arrayList, $number);
    }
