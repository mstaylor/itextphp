<?PHP
/*
 * $Id: ColorDetails.php,v 1.2 2005/10/18 16:49:37 mstaylor Exp $
 * $Name:  $
 *
...
class ColorDetails
{
    ...
    */
    public function __construct(PdfName $colorName, PdfIndirectReference $indirectReference, PdfSpotColor $scolor) {
    ...
    */
    function getSpotColor(PdfWriter $writer) {
