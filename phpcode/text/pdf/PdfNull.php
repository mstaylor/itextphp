<?PHP
/*
 * $Id: PdfNull.php,v 1.2 2005/10/12 21:22:58 mstaylor Exp $
 * $Name:  $
 *
...
class PdfNull extends PdfObject {
    ...
    {
        if(PdfNull::$initialized == FALSE)
        {
            PdfNull::$PDFNULL = new PdfNull();
            PdfNull::$initialized = TRUE;
        }
    }
    ...
    */
    ...
    public function __construct() {
        parent::__construct(PdfObject::aNULL, PdfNull::$CONTENT);
    }
