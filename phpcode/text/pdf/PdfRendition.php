<?PHP
/*
 * $Id: PdfRendition.php,v 1.2 2005/10/18 16:44:37 mstaylor Exp $
 * $Name:  $
 *
...
require_once("PdfMediaClipData.php");

/**
* A Rendition dictionary (pdf spec 1.5)
*/
class PdfRendition extends PdfDictionary {
     public function __construct($file, PdfFileSpecification $fs, $mimeType) {
