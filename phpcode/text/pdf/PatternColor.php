<?PHP
/*
 * $Id: PatternColor.php,v 1.2 2005/10/19 16:32:34 mstaylor Exp $
 * $Name:  $
 *
...
*/
class PatternColor extends ExtendedColor
{
    ...
    */
    public function __construct(PdfPatternPainter $painter) {
        parent::__construct(ExtendedColor::TYPE_PATTERN, 0.5, 0.5, 0.5);
