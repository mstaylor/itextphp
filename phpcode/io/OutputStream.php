<?PHP
/*
 * $Id: OutputStream.php,v 1.3 2005/12/22 21:22:28 mstaylor Exp $
 * $Name:  $
 *
...
{
   abstract public function write ();//note this should be overloaded to match the java spec
       ...
       $num_args=func_num_args();
        switch ($num_args)
        {
            ...
            case 3:
            {
                ...
                {
                    writeresource3args($arg1, $arg2, $ar3);
                }
                break;
            }
        }
   }
   abstract private function writeInt($b);
